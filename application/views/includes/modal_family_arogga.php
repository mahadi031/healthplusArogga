<div class="modal fade" id="modal_family_arogga" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-footer ">
                ...
                <div class="text-center mt-2">
                    <a class="btn btn-primary <?php if ($is_sebscribe) { ?>
                        disabled
                   <?php } ?>" href="<?php echo base_url("AroggaPackCheck/subscirbe_request?package_type=family_arogga") ?>" style="border-radius: 5px; padding: 8px 24px;">Purchase Now</a>
                </div>
